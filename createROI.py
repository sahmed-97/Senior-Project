...
def createRoiDf(roiImg, ROILabels, numSegsX, numSegsY):
    '''
    ...
    print(ROILabels['colorVal'])
    label = ROILabels[(ROILabels['colorVal'] == roiDicts['colorVal'])]
    roiDicts.append({'Label': label})
...
if __name__ == "__main__":
    ...
    ROILabels = pd.read_csv('/Users/sheelaahmed/Desktop/NAS/roiLabels.csv')
    roi_image = cv2.imread('/Users/sheelaahmed/Desktop/NAS/mag_roi.png')

    roiDf = createRoiDf(roi_image, ROILabels, numSegsX=5, numSegsY=3)

    roiDf.to_pickle("ROIDataframeMagazines_without_gray2.pickle")
